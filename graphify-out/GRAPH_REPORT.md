...
## Corpus Check
- 55 files · ~347,148 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 935 nodes · 1374 edges · 69 communities detected
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 159 edges (avg confidence: 0.8)
...
Cohesion: 0.04
Nodes (25): nxs2BeatCountToMs(), shouldKeepPredictedBeatAnchor(), BridgeCore, _dbgLog(), _resolveDbgLogPath(), parseDbRequest(), test(), push() (+17 more)
...
Cohesion: 0.25
Nodes (10): dbArg4(), dbBinary(), dbBuildArtResponse(), dbBuildMenuItem(), dbBuildMsg(), dbNum1(), dbNum2(), dbNum4() (+2 more)
...
Cohesion: 0.18
Nodes (4): _isIPv4(), _escHtml(), _safeImgSrc(), test()
...
- **Why does `push()` connect `Community 0` to `Community 3`, `Community 6`, `Community 39`, `Community 13`, `Community 15`, `Community 20`, `Community 29`, `Community 30`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `BridgeCore` connect `Community 0` to `Community 20`, `Community 13`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `buildHtml()` connect `Community 30` to `Community 0`?**

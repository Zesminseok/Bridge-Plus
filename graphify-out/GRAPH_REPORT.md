# Graph Report - /Users/zes2021/Documents/claude_projects/bridge-clone  (2026-04-28)

## Corpus Check
- 50 files · ~339,836 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 907 nodes · 1336 edges · 67 communities detected
...
7. `getAllInterfaces()` - 13 edges
8. `OverviewGL` - 13 edges
9. `buildHdr()` - 13 edges
...
Cohesion: 0.06
Nodes (19): BridgeCore, _dbgLog(), detectBroadcastFor(), getAllInterfaces(), _getHWPortMap(), pdjlBroadcastTargets(), _resolveDbgLogPath(), dbArg4() (+11 more)
...
Cohesion: 0.09
Nodes (28): analyze(), _bq(), buildHtml(), decodeWav(), _mkBQ(), _mkHP(), rgbTraceColor(), smoothEnv() (+20 more)
...
Cohesion: 0.09
Nodes (11): interfaceSignature(), ArtnetEngine, createWindow(), doQuit(), getLocalIp(), loadBounds(), saveBounds(), sendArtTimeCode() (+3 more)
...
Cohesion: 0.1
Nodes (18): nxs2BeatCountToMs(), shouldKeepPredictedBeatAnchor(), test(), buildBridgeNotifyPacket(), buildDbServerKeepalivePacket(), buildDjmSubscribePacket(), buildPdjlBridgeClaimPacket(), buildPdjlBridgeHelloPacket() (+10 more)
...
Cohesion: 0.18
Nodes (15): analyzeBPM(), detectAudioStart(), _findByNameUnix(), _findByNameWin(), _findByPortUnix(), _findByPortWin(), isProtected(), _killUnix() (+7 more)

### Community 15 - "Community 15"
Cohesion: 0.22
Nodes (14): buildHdr(), mkAppResp(), mkDataMeta(), mkDataMetrics(), mkLowResArtwork(), mkMetadataResp(), mkMixerData(), mkNotification() (+6 more)
...
- **Thin community `Community 46`** (2 nodes): `registerLicenseIpc()`, `ipc-license.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 47`** (2 nodes): `registerBridgeStartIpc()`, `ipc-bridge-start.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (2 nodes): `registerLinkIpc()`, `ipc-link.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 49`** (2 nodes): `registerBridgeIfaceIpc()`, `ipc-bridge-iface.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 50`** (2 nodes): `registerAppIpc()`, `ipc-app.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 51`** (2 nodes): `registerArtnetIpc()`, `ipc-artnet.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 52`** (2 nodes): `registerBridgeSimpleIpc()`, `ipc-bridge-simple.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 53`** (2 nodes): `Proposal C - Minimal Tactical (light theme)`, `3-column body layout (260/flex/320)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 54`** (2 nodes): `Information priority: Timecode > Waveform > Track ID > BPM > others`, `Proposal G - Timecode First (Monolith) information hierarchy`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 55`** (2 nodes): `Preview Develop - G.ROW + Waveform 2-band + Beat Ring + Knob Arc`, `Preview v2 - TOWER/CARD/ROW developed with channel strip + fader`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 56`** (1 nodes): `preload.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `push()` connect `Community 0` to `Community 4`, `Community 6`, `Community 7`, `Community 9`, `Community 14`, `Community 15`, `Community 28`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `BridgeCore` connect `Community 0` to `Community 9`, `Community 15`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `buildHtml()` connect `Community 4` to `Community 0`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Are the 39 inferred relationships involving `push()` (e.g. with `_dbgLog()` and `getAllInterfaces()`) actually correct?**
  _`push()` has 39 INFERRED edges - model-reasoned connections that need verification._

...
## Corpus Check
- 54 files · ~347,075 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 927 nodes · 1363 edges · 67 communities detected
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 144 edges (avg confidence: 0.8)
...
Cohesion: 0.05
Nodes (22): BridgeCore, _dbgLog(), _resolveDbgLogPath(), dbArg4(), dbBinary(), dbBuildArtResponse(), dbBuildMenuItem(), dbBuildMsg() (+14 more)
...
Cohesion: 0.19
Nodes (15): _findByNameUnix(), _findByNameWin(), _findByPortUnix(), _findByPortWin(), isProtected(), _killUnix(), _killWin(), _pidNameUnix() (+7 more)
...
- **Why does `push()` connect `Community 0` to `Community 3`, `Community 37`, `Community 5`, `Community 7`, `Community 14`, `Community 16`, `Community 27`, `Community 28`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `BridgeCore` connect `Community 0` to `Community 5`, `Community 14`?**

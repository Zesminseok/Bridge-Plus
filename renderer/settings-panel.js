...
function renderSettings(){
  ...
  el.innerHTML=`
    ...
    <div class="sgr">
      ...
      <div class="srw"><span class="srl" data-i18n="set_message">메시지</span><span id="licStatusDetail" class="srv" style="max-width:260px;text-align:right;color:var(--tx3)">${(window.t?window.t('lic_demo_build','Demo build'):'Demo build')} · 60${(window.t?window.t('lic_days_remaining_suffix',' days remaining'):' days remaining')}</span></div>
    </div>

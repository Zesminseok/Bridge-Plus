...
[![Version](https://img.shields.io/badge/version-1.0.0.10-orange.svg)](CHANGELOG.md)
...
- **macOS**: `BRIDGE+-1.0.0.10-mac-x64.dmg` / `-mac-arm64.dmg`
- **Windows**: `BRIDGE+-1.0.0.10-win-x64.exe`
